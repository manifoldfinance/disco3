...
export declare const Heading: React.ForwardRefExoticComponent<Pick<HeadingProps, "size" | "as" | "variant" | "gradient" | "css" | "key" | keyof React.HTMLAttributes<HTMLHeadingElement>> & React.RefAttributes<HTMLHeadingElement>>;
export {};
