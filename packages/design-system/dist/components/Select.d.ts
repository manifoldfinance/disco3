...
export declare const Select: React.ForwardRefExoticComponent<Pick<SelectProps, "key" | keyof React.SelectHTMLAttributes<HTMLSelectElement> | "css"> & React.RefAttributes<HTMLSelectElement>>;
export {};
