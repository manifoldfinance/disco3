...
export declare const Paragraph: React.ForwardRefExoticComponent<Pick<ParagraphProps, "size" | "as" | "variant" | "gradient" | "css" | "key" | keyof React.HTMLAttributes<HTMLParagraphElement>> & React.RefAttributes<HTMLParagraphElement>>;
export {};
