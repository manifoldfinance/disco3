...
var StyledContent$3 = styled(AccordionPrimitive.Content, {
    p: '$2',
});
...
function AlertDialog(_a) {
    ...
    return (React.createElement(AlertDialogPrimitive.Root, __assign({}, props),
        React.createElement(StyledOverlay$2, null),
        children));
}
var AlertDialogContent = styled(AlertDialogPrimitive.Content, panelStyles, {
    position: 'fixed',
    top: '50%',
    left: '50%',
...
var Select = React.forwardRef(function (_a, forwardedRef) {
...
var DesignSystemProvider = function (_a) {
    ...
    return (React.createElement(IdProvider, null, children));
};
...
var DialogContent = React.forwardRef(function (_a, forwardedRef) {
    var children = _a.children, props = __rest(_a, ["children"]);
    return (React.createElement(StyledContent$2, __assign({}, props, { ref: forwardedRef }),
        children,
...
var DropdownMenuRadioItem = React.forwardRef(function (_a, forwardedRef) {
    var children = _a.children, props = __rest(_a, ["children"]);
...
var DropdownMenuCheckboxItem = React.forwardRef(function (_a, forwardedRef) {
    var children = _a.children, props = __rest(_a, ["children"]);
...
function Popover(_a) {
    var children = _a.children, props = __rest(_a, ["children"]);
    return React.createElement(PopoverPrimitive.Root, __assign({}, props), children);
}
var StyledContent$1 = styled(PopoverPrimitive.Content, panelStyles, {
    minWidth: 200,
    minHeight: '$6',
    maxWidth: 265,
    '&:focus': {
...
var PopoverContent = React.forwardRef(function (_a, fowardedRef) {
    ...
    return (React.createElement(StyledContent$1, __assign({ sideOffset: 0 }, props, { ref: fowardedRef }),
        children,
        !hideArrow && (React.createElement(Box, { css: { color: '$panel' } },
            React.createElement(PopoverPrimitive.Arrow, { width: 11, height: 5, offset: 5, style: { fill: 'currentColor' } })))));
});
...
var SheetContent = React.forwardRef(function (_a, forwardedRef) {
    var children = _a.children, props = __rest(_a, ["children"]);
    return (React.createElement(StyledContent, __assign({}, props, { ref: forwardedRef }),
        children,
...
var Switch = React.forwardRef(function (props, forwardedRef) { return (React.createElement(StyledSwitch, __assign({}, props, { ref: forwardedRef }),
...
var TabsList = React.forwardRef(function (props, forwardedRef) { return (React.createElement(React.Fragment, null,
    React.createElement(StyledTabsList, __assign({}, props, { ref: forwardedRef })),
...
function Tooltip(_a) {
    ...
    return (React.createElement(TooltipPrimitive.Root, { open: open, defaultOpen: defaultOpen, onOpenChange: onOpenChange },
        React.createElement(TooltipPrimitive.Trigger, { asChild: true }, children),
        React.createElement(Content, __assign({ side: "top", align: "center", sideOffset: 5 }, props, { multiline: multiline }),
            ...
            React.createElement(Box, { css: { color: '$transparentExtreme' } },
                React.createElement(TooltipPrimitive.Arrow, { offset: 5, width: 11, height: 5, style: {
                        fill: 'currentColor',
                    } })))));
}
